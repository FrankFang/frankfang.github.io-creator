...
date: 2016-12-12T01:45:22+08:00
isCJKLanguage: true
---
...
![](/images/new-in-js/2.jpg)

只要你在士兵前面使用 new 关键字，那么可以少做四件事情：

1. 不用创建临时对象，因为 new 会帮你做（__你使用「this」就可以访问到临时对象__）；  
...
__new 的作用，就是省那么几行代码。（也就是所谓的语法糖）__
